<template>
  <div class="index">
    ...
    <div class="Wheel-planting">
      <!-- <img src="../../public/photo/- (2).jpg" alt=""> -->
      <el-carousel height="450px" trigger="click" :interval="1000">
        <el-carousel-item class="item">
          <img src="../../public/photo/Lunbo/wheel2.jpg" alt="">
        </el-carousel-item>
        <el-carousel-item class="item">
          <img src="../../public/photo/- (2).jpg" alt="">
        </el-carousel-item>
        <el-carousel-item class="item">
          <img src="../../public/photo/-1200-438 (1).jpg" alt="">
        </el-carousel-item>
        <el-carousel-item class="item">
          <img src="../../public/photo/-.jpg" alt="">
        </el-carousel-item>
        <el-carousel-item class="item">
          <img src="../../public/photo/-1200-438.jpg" alt="">
        </el-carousel-item>
      </el-carousel>
    </div>
    <!-- *******3F分类****** -->
    ...
    <div class="f4">
      <div class="f4-top">
        <h3>梦蛋糕</h3>
        <ul>
          <li><a href="">梦蛋糕</a>&nbsp;丨</li>
          <li><a href="">巧克力蛋糕</a>&nbsp;丨</li>
          <li><a href="">慕斯蛋糕</a>&nbsp;丨</li>
          <li><a href="">婚庆蛋糕</a>&nbsp;丨</li>
          <li><a href="">蛋糕配件</a></li>
        </ul>
      </div>
      <div class="f4-bottom">
